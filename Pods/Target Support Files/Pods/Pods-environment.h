...
// Aftership-iOS-SDK
#define COCOAPODS_POD_AVAILABLE_Aftership_iOS_SDK
#define COCOAPODS_VERSION_MAJOR_Aftership_iOS_SDK 1
#define COCOAPODS_VERSION_MINOR_Aftership_iOS_SDK 0
#define COCOAPODS_VERSION_PATCH_Aftership_iOS_SDK 0
