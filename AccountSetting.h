...
@property (weak, nonatomic) IBOutlet UISwitch *appAlertsSwitch;
@property (weak, nonatomic) IBOutlet UISwitch *emailAlertsSwitch;
@property (weak, nonatomic) IBOutlet UISwitch *smsAlertsSwitch;
